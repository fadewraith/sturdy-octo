...
public class MergeTwoSortedArrays {
    ...
    private static void solution(int[] nums1, int n1, int[] nums2, int n2) {
        // reverse 2 pointers, below are the 2 pointers
 ...
 *
 * Initial Setup: We initialize two pointers: x at m-1 (last element of nums1’s valid portion) and y at n-1 (last element of nums2). A third pointer, z, starts at m+n-1 (the last position in nums1) to place merged elements.
 ...
 * These pointers help us compare elements from both arrays and place the larger one at position z, then move backwards.
