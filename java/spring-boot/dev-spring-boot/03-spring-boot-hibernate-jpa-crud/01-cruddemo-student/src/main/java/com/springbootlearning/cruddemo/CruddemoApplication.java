...
//		create multiple students
		System.out.println("Creating new student object ...");
		Student tempStudent1 = new Student("Hello", "World", "hello@world.com");
		Student tempStudent2 = new Student("Paul", "Martin", "paul@martin.com");
		Student tempStudent3 = new Student("Bonita", "Apple", "bonita@apple.com");
