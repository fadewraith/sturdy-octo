...
public class DequeueMethods {
    ...
    public static void main(String[] args) {
        ...
        // poll() returns null if no element available
        String element2 = blockingQueue.poll();

        // poll(long timeout, TimeUnit timeUnit) blocks up until timeout for an element to become available. If no element is available before that time, null is returned.
        try {
